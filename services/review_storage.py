...
def build_issue(issue_data, default_source="user", default_side="", default_creator="Unknown"):
    ...
    return {
        ...
        "alignment_confidence": issue_data.get("alignment_confidence", "high"),
        "left_section_start_index": issue_data.get("left_section_start_index"),
        "left_section_end_index": issue_data.get("left_section_end_index"),
        "right_section_start_index": issue_data.get("right_section_start_index"),
        "right_section_end_index": issue_data.get("right_section_end_index"),
