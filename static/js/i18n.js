(() => {
  ...
  const fr = {
    ...
    "Issues panel is unavailable in single view.": "Le panneau des problèmes n’est pas disponible en vue unique.",
    ...
    "Update this content source without recreating it.": "Mettez à jour cette source de contenu sans la recréer.",
    ...
    "Reloading website pages...": "Rechargement des pages du site Web…",
    ...
    "Add a review note for the currently selected block.": "Ajoutez une note de révision pour le bloc actuellement sélectionné.",
    "Close issue form": "Fermer le formulaire de problème",
    "Reviewer name": "Nom de la personne chargée de la révision",
    "Your name will be remembered for the next issue.": "Votre nom sera mémorisé pour le prochain problème.",
    "Issue title": "Titre du problème",
    "Issue location": "Emplacement du problème",
    "English page": "Page anglaise",
    "Mark the selected English block.": "Signaler le bloc anglais sélectionné.",
    "French page": "Page française",
    "Mark the selected French block.": "Signaler le bloc français sélectionné.",
    "Comment": "Commentaire",
    "Create issue": "Créer le problème",
    "User": "Utilisateur",
    "Auto": "Auto",
    "Status:": "État :",
    "By:": "Par :",
